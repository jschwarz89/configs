# Generated by Powerlevel10k configuration wizard on 2024-10-27 at 14:35 IST.
...
# 24h time, round separators, round heads, flat tails, 1 line, compact, few icons,
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_UNSTAGED || VCS_STATUS_NUM_STAGED )) && res+="*"
